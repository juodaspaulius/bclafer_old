...
instance Print PosImmutable where
  prt _ (PosImmutable (_,i)) = doc (showString ( i))
...
instance Print ConstrExp where
  prt i e = case e of
   TmpPrecedes exp0 exp tmpscope -> prPrec i 0 (concatD [prt 0 exp0 , doc (showString "precedes") , prt 0 exp , prt 0 tmpscope])
   PosTmpPrecedes span exp0 exp tmpscope -> prPrec i 0 (concatD [prt 0 span , prt 0 exp0 , doc (showString "precedes") , prt 0 exp , prt 0 tmpscope])
   TmpRespondsTo exp0 exp tmpscope -> prPrec i 0 (concatD [prt 0 exp0 , doc (showString "respondsTo") , prt 0 exp , prt 0 tmpscope])
   PosTmpRespondsTo span exp0 exp tmpscope -> prPrec i 0 (concatD [prt 0 span , prt 0 exp0 , doc (showString "respondsTo") , prt 0 exp , prt 0 tmpscope])
   TmpAbsence exp tmpscope -> prPrec i 1 (concatD [prt 0 exp , doc (showString "is") , doc (showString "false") , prt 0 tmpscope])
   PosTmpAbsence span exp tmpscope -> prPrec i 1 (concatD [prt 0 span , prt 0 exp , doc (showString "is") , doc (showString "false") , prt 0 tmpscope])
   TmpUniversality exp tmpscope -> prPrec i 1 (concatD [prt 0 exp , prt 0 tmpscope])
   PosTmpUniversality span exp tmpscope -> prPrec i 1 (concatD [prt 0 span , prt 0 exp , prt 0 tmpscope])
   TmpBoundedExistence exp posinteger tmpscope -> prPrec i 1 (concatD [prt 0 exp , prt 0 posinteger , doc (showString "times") , prt 0 tmpscope])
   PosTmpBoundedExistence span exp posinteger tmpscope -> prPrec i 1 (concatD [prt 0 span , prt 0 exp , prt 0 posinteger , doc (showString "times") , prt 0 tmpscope])
   TmpExistence exp tmpscope -> prPrec i 1 (concatD [doc (showString "eventually") , prt 0 exp , prt 0 tmpscope])
   PosTmpExistence span exp tmpscope -> prPrec i 1 (concatD [prt 0 span , doc (showString "eventually") , prt 0 exp , prt 0 tmpscope])
   ConstrExpOr constrexp0 constrexp -> prPrec i 2 (concatD [prt 2 constrexp0 , doc (showString "||") , prt 3 constrexp])
   PosConstrExpOr span constrexp0 constrexp -> prPrec i 2 (concatD [prt 0 span , prt 2 constrexp0 , doc (showString "||") , prt 3 constrexp])
   ConstrExpAnd constrexp0 constrexp -> prPrec i 3 (concatD [prt 3 constrexp0 , doc (showString "&&") , prt 4 constrexp])
   PosConstrExpAnd span constrexp0 constrexp -> prPrec i 3 (concatD [prt 0 span , prt 3 constrexp0 , doc (showString "&&") , prt 4 constrexp])
   NonPatternsExp exp -> prPrec i 4 (concatD [prt 0 exp])
   PosNonPatternsExp span exp -> prPrec i 4 (concatD [prt 0 span , prt 0 exp])
   ImmutableConstr posimmutable -> prPrec i 0 (concatD [prt 0 posimmutable])
   PosImmutableConstr span posimmutable -> prPrec i 0 (concatD [prt 0 span , prt 0 posimmutable])
...
instance Print Exp where
  prt i e = case e of
   ...
   LtlRel exp0 exp -> prPrec i 6 (concatD [prt 6 exp0 , doc (showString "R") , prt 7 exp])
   PosLtlRel span exp0 exp -> prPrec i 6 (concatD [prt 0 span , prt 6 exp0 , doc (showString "R") , prt 7 exp])
   LtlUntil exp0 exp -> prPrec i 6 (concatD [prt 6 exp0 , doc (showString "U") , prt 7 exp])
   PosLtlUntil span exp0 exp -> prPrec i 6 (concatD [prt 0 span , prt 6 exp0 , doc (showString "U") , prt 7 exp])
   LtlWUntil exp0 exp -> prPrec i 6 (concatD [prt 6 exp0 , doc (showString "W") , prt 7 exp])
   PosLtlWUntil span exp0 exp -> prPrec i 6 (concatD [prt 0 span , prt 6 exp0 , doc (showString "W") , prt 7 exp])
   LtlF exp -> prPrec i 7 (concatD [doc (showString "F") , prt 8 exp])
   PosLtlF span exp -> prPrec i 7 (concatD [prt 0 span , doc (showString "F") , prt 8 exp])
   LtlG exp -> prPrec i 7 (concatD [doc (showString "G") , prt 8 exp])
   PosLtlG span exp -> prPrec i 7 (concatD [prt 0 span , doc (showString "G") , prt 8 exp])
   LtlX exp -> prPrec i 8 (concatD [doc (showString "X") , prt 9 exp])
   PosLtlX span exp -> prPrec i 8 (concatD [prt 0 span , doc (showString "X") , prt 9 exp])
   ENeg exp -> prPrec i 9 (concatD [doc (showString "!") , prt 10 exp])
   PosENeg span exp -> prPrec i 9 (concatD [prt 0 span , doc (showString "!") , prt 10 exp])
   ELt exp0 exp -> prPrec i 10 (concatD [prt 10 exp0 , doc (showString "<") , prt 11 exp])
   PosELt span exp0 exp -> prPrec i 10 (concatD [prt 0 span , prt 10 exp0 , doc (showString "<") , prt 11 exp])
   EGt exp0 exp -> prPrec i 10 (concatD [prt 10 exp0 , doc (showString ">") , prt 11 exp])
   PosEGt span exp0 exp -> prPrec i 10 (concatD [prt 0 span , prt 10 exp0 , doc (showString ">") , prt 11 exp])
   EEq exp0 exp -> prPrec i 10 (concatD [prt 10 exp0 , doc (showString "=") , prt 11 exp])
   PosEEq span exp0 exp -> prPrec i 10 (concatD [prt 0 span , prt 10 exp0 , doc (showString "=") , prt 11 exp])
   ELte exp0 exp -> prPrec i 10 (concatD [prt 10 exp0 , doc (showString "<=") , prt 11 exp])
   PosELte span exp0 exp -> prPrec i 10 (concatD [prt 0 span , prt 10 exp0 , doc (showString "<=") , prt 11 exp])
   EGte exp0 exp -> prPrec i 10 (concatD [prt 10 exp0 , doc (showString ">=") , prt 11 exp])
   PosEGte span exp0 exp -> prPrec i 10 (concatD [prt 0 span , prt 10 exp0 , doc (showString ">=") , prt 11 exp])
   ENeq exp0 exp -> prPrec i 10 (concatD [prt 10 exp0 , doc (showString "!=") , prt 11 exp])
   PosENeq span exp0 exp -> prPrec i 10 (concatD [prt 0 span , prt 10 exp0 , doc (showString "!=") , prt 11 exp])
   EIn exp0 exp -> prPrec i 10 (concatD [prt 10 exp0 , doc (showString "in") , prt 11 exp])
   PosEIn span exp0 exp -> prPrec i 10 (concatD [prt 0 span , prt 10 exp0 , doc (showString "in") , prt 11 exp])
   ENin exp0 exp -> prPrec i 10 (concatD [prt 10 exp0 , doc (showString "not") , doc (showString "in") , prt 11 exp])
   PosENin span exp0 exp -> prPrec i 10 (concatD [prt 0 span , prt 10 exp0 , doc (showString "not") , doc (showString "in") , prt 11 exp])
   QuantExp quant exp -> prPrec i 11 (concatD [prt 0 quant , prt 15 exp])
   PosQuantExp span quant exp -> prPrec i 11 (concatD [prt 0 span , prt 0 quant , prt 15 exp])
   EAdd exp0 exp -> prPrec i 12 (concatD [prt 12 exp0 , doc (showString "+") , prt 13 exp])
   PosEAdd span exp0 exp -> prPrec i 12 (concatD [prt 0 span , prt 12 exp0 , doc (showString "+") , prt 13 exp])
   ESub exp0 exp -> prPrec i 12 (concatD [prt 12 exp0 , doc (showString "-") , prt 13 exp])
   PosESub span exp0 exp -> prPrec i 12 (concatD [prt 0 span , prt 12 exp0 , doc (showString "-") , prt 13 exp])
   EMul exp0 exp -> prPrec i 13 (concatD [prt 13 exp0 , doc (showString "*") , prt 14 exp])
   PosEMul span exp0 exp -> prPrec i 13 (concatD [prt 0 span , prt 13 exp0 , doc (showString "*") , prt 14 exp])
   EDiv exp0 exp -> prPrec i 13 (concatD [prt 13 exp0 , doc (showString "/") , prt 14 exp])
   PosEDiv span exp0 exp -> prPrec i 13 (concatD [prt 0 span , prt 13 exp0 , doc (showString "/") , prt 14 exp])
   ESumSetExp exp -> prPrec i 14 (concatD [doc (showString "sum") , prt 15 exp])
   PosESumSetExp span exp -> prPrec i 14 (concatD [prt 0 span , doc (showString "sum") , prt 15 exp])
   ECSetExp exp -> prPrec i 14 (concatD [doc (showString "#") , prt 15 exp])
   PosECSetExp span exp -> prPrec i 14 (concatD [prt 0 span , doc (showString "#") , prt 15 exp])
   EMinExp exp -> prPrec i 14 (concatD [doc (showString "-") , prt 15 exp])
   PosEMinExp span exp -> prPrec i 14 (concatD [prt 0 span , doc (showString "-") , prt 15 exp])
   EImpliesElse exp0 exp1 exp -> prPrec i 15 (concatD [doc (showString "if") , prt 15 exp0 , doc (showString "then") , prt 15 exp1 , doc (showString "else") , prt 16 exp])
   PosEImpliesElse span exp0 exp1 exp -> prPrec i 15 (concatD [prt 0 span , doc (showString "if") , prt 15 exp0 , doc (showString "then") , prt 15 exp1 , doc (showString "else") , prt 16 exp])
   EInt posinteger -> prPrec i 16 (concatD [prt 0 posinteger])
   PosEInt span posinteger -> prPrec i 16 (concatD [prt 0 span , prt 0 posinteger])
   EDouble posdouble -> prPrec i 16 (concatD [prt 0 posdouble])
   PosEDouble span posdouble -> prPrec i 16 (concatD [prt 0 span , prt 0 posdouble])
   EStr posstring -> prPrec i 16 (concatD [prt 0 posstring])
   PosEStr span posstring -> prPrec i 16 (concatD [prt 0 span , prt 0 posstring])
   ESetExp setexp -> prPrec i 16 (concatD [prt 0 setexp])
   PosESetExp span setexp -> prPrec i 16 (concatD [prt 0 span , prt 0 setexp])
