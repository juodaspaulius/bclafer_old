...
instance Print ConstrExp where
  prt i e = case e of
   ...
   TmpAbsence exp tmpscope -> prPrec i 0 (concatD [prt 0 exp , doc (showString "is") , doc (showString "false") , prt 0 tmpscope])
   PosTmpAbsence span exp tmpscope -> prPrec i 0 (concatD [prt 0 span , prt 0 exp , doc (showString "is") , doc (showString "false") , prt 0 tmpscope])
   TmpExistence exp tmpscope -> prPrec i 0 (concatD [prt 0 exp , doc (showString "is") , doc (showString "true") , prt 0 tmpscope])
   PosTmpExistence span exp tmpscope -> prPrec i 0 (concatD [prt 0 span , prt 0 exp , doc (showString "is") , doc (showString "true") , prt 0 tmpscope])
   TmpBoundedExistence exp posinteger tmpscope -> prPrec i 0 (concatD [prt 0 exp , doc (showString "is") , doc (showString "true") , prt 0 posinteger , doc (showString "times") , prt 0 tmpscope])
   PosTmpBoundedExistence span exp posinteger tmpscope -> prPrec i 0 (concatD [prt 0 span , prt 0 exp , doc (showString "is") , doc (showString "true") , prt 0 posinteger , doc (showString "times") , prt 0 tmpscope])
   NonPatternsExp exp -> prPrec i 0 (concatD [prt 0 exp])
   PosNonPatternsExp span exp -> prPrec i 0 (concatD [prt 0 span , prt 0 exp])
