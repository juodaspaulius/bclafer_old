...
instance Print Immutable where
  prt _ (Immutable (_,i)) = doc (showString ( i))
...
instance Print Constraint where
  prt i e = case e of
   Constraint constrexps -> prPrec i 0 (concatD [doc (showString "[") , prt 0 constrexps , doc (showString "]")])
   PosConstraint span constrexps -> prPrec i 0 (concatD [prt 0 span , doc (showString "[") , prt 0 constrexps , doc (showString "]")])
...
instance Print TmpScope where
  prt i e = case e of
   TmpScopeGlobally  -> prPrec i 0 (concatD [doc (showString "globally")])
   PosTmpScopeGlobally span -> prPrec i 0 (concatD [prt 0 span , doc (showString "globally")])
   TmpScopeBefore exp -> prPrec i 0 (concatD [doc (showString "before") , prt 0 exp])
   PosTmpScopeBefore span exp -> prPrec i 0 (concatD [prt 0 span , doc (showString "before") , prt 0 exp])
   TmpScopeAfter exp -> prPrec i 0 (concatD [doc (showString "after") , prt 0 exp])
   PosTmpScopeAfter span exp -> prPrec i 0 (concatD [prt 0 span , doc (showString "after") , prt 0 exp])
   TmpScopeBetweenAnd exp0 exp -> prPrec i 0 (concatD [doc (showString "between") , prt 0 exp0 , doc (showString "and") , prt 0 exp])
   PosTmpScopeBetweenAnd span exp0 exp -> prPrec i 0 (concatD [prt 0 span , doc (showString "between") , prt 0 exp0 , doc (showString "and") , prt 0 exp])
   TmpScopeAfterUntil exp0 exp -> prPrec i 0 (concatD [doc (showString "after") , prt 0 exp0 , doc (showString "until") , prt 0 exp])
   PosTmpScopeAfterUntil span exp0 exp -> prPrec i 0 (concatD [prt 0 span , doc (showString "after") , prt 0 exp0 , doc (showString "until") , prt 0 exp])


instance Print ConstrExp where
  prt i e = case e of
   ImmutableConstr immutable -> prPrec i 0 (concatD [prt 0 immutable])
   PosImmutableConstr span immutable -> prPrec i 0 (concatD [prt 0 span , prt 0 immutable])
   ConstrExp exp -> prPrec i 0 (concatD [prt 0 exp])
   PosConstrExp span exp -> prPrec i 0 (concatD [prt 0 span , prt 0 exp])

  prtList es = case es of
   [] -> (concatD [])
   x:xs -> (concatD [prt 0 x , prt 0 xs])

instance Print DeclLetBindingValue where
  prt i e = case e of
   DeclLetBindingValue posident exp -> prPrec i 0 (concatD [prt 0 posident , doc (showString "=") , prt 0 exp])
   PosDeclLetBindingValue span posident exp -> prPrec i 0 (concatD [prt 0 span , prt 0 posident , doc (showString "=") , prt 0 exp])

  prtList es = case es of
   [x] -> (concatD [prt 0 x])
   x:xs -> (concatD [prt 0 x , doc (showString ",") , prt 0 xs])

instance Print DeclBindingSet where
  prt i e = case e of
   DeclBindingSet posident setexp -> prPrec i 0 (concatD [prt 0 posident , doc (showString ":") , prt 0 setexp])
   PosDeclBindingSet span posident setexp -> prPrec i 0 (concatD [prt 0 span , prt 0 posident , doc (showString ":") , prt 0 setexp])
...
instance Print SetExp where
  prt i e = case e of
   DeclBindSet1 declbindingsets exp -> prPrec i 0 (concatD [doc (showString "{") , prt 0 declbindingsets , doc (showString "|") , prt 0 exp , doc (showString "}")])
   PosDeclBindSet1 span declbindingsets exp -> prPrec i 0 (concatD [prt 0 span , doc (showString "{") , prt 0 declbindingsets , doc (showString "|") , prt 0 exp , doc (showString "}")])
   DeclBindSet2 decls exp -> prPrec i 0 (concatD [doc (showString "{") , prt 0 decls , doc (showString "|") , prt 0 exp , doc (showString "}")])
   PosDeclBindSet2 span decls exp -> prPrec i 0 (concatD [prt 0 span , doc (showString "{") , prt 0 decls , doc (showString "|") , prt 0 exp , doc (showString "}")])
...
instance Print Exp where
  prt i e = case e of
   DeclLetBindValue declletbindingvalues exp -> prPrec i 16 (concatD [doc (showString "let") , prt 0 declletbindingvalues , doc (showString "|") , prt 0 exp])
   PosDeclLetBindValue span declletbindingvalues exp -> prPrec i 16 (concatD [prt 0 span , doc (showString "let") , prt 0 declletbindingvalues , doc (showString "|") , prt 0 exp])
   ...
   TmpPrecedes exp0 exp tmpscope -> prPrec i 1 (concatD [prt 4 exp0 , doc (showString "precedes") , prt 0 exp , prt 0 tmpscope])
   PosTmpPrecedes span exp0 exp tmpscope -> prPrec i 1 (concatD [prt 0 span , prt 4 exp0 , doc (showString "precedes") , prt 0 exp , prt 0 tmpscope])
   TmpRespondsTo exp0 exp tmpscope -> prPrec i 1 (concatD [prt 4 exp0 , doc (showString "respondsTo") , prt 0 exp , prt 0 tmpscope])
   PosTmpRespondsTo span exp0 exp tmpscope -> prPrec i 1 (concatD [prt 0 span , prt 4 exp0 , doc (showString "respondsTo") , prt 0 exp , prt 0 tmpscope])
   TmpAbsence exp tmpscope -> prPrec i 1 (concatD [prt 4 exp , doc (showString "is") , doc (showString "false") , prt 0 tmpscope])
   PosTmpAbsence span exp tmpscope -> prPrec i 1 (concatD [prt 0 span , prt 4 exp , doc (showString "is") , doc (showString "false") , prt 0 tmpscope])
   TmpUniversality exp tmpscope -> prPrec i 1 (concatD [prt 4 exp , doc (showString "is") , doc (showString "true") , prt 0 tmpscope])
   PosTmpUniversality span exp tmpscope -> prPrec i 1 (concatD [prt 0 span , prt 4 exp , doc (showString "is") , doc (showString "true") , prt 0 tmpscope])
   TmpBoundedExistence exp posinteger tmpscope -> prPrec i 1 (concatD [prt 4 exp , doc (showString "is") , doc (showString "true") , prt 0 posinteger , doc (showString "times") , prt 0 tmpscope])
   PosTmpBoundedExistence span exp posinteger tmpscope -> prPrec i 1 (concatD [prt 0 span , prt 4 exp , doc (showString "is") , doc (showString "true") , prt 0 posinteger , doc (showString "times") , prt 0 tmpscope])
   TmpExistence exp tmpscope -> prPrec i 1 (concatD [doc (showString "eventually") , prt 4 exp , prt 0 tmpscope])
   PosTmpExistence span exp tmpscope -> prPrec i 1 (concatD [prt 0 span , doc (showString "eventually") , prt 4 exp , prt 0 tmpscope])
   EGMax exp -> prPrec i 2 (concatD [doc (showString "max") , prt 3 exp])
   PosEGMax span exp -> prPrec i 2 (concatD [prt 0 span , doc (showString "max") , prt 3 exp])
   EGMin exp -> prPrec i 3 (concatD [doc (showString "min") , prt 4 exp])
   PosEGMin span exp -> prPrec i 3 (concatD [prt 0 span , doc (showString "min") , prt 4 exp])
   EIff exp0 exp -> prPrec i 4 (concatD [prt 4 exp0 , doc (showString "<=>") , prt 5 exp])
   PosEIff span exp0 exp -> prPrec i 4 (concatD [prt 0 span , prt 4 exp0 , doc (showString "<=>") , prt 5 exp])
   EImplies exp0 exp -> prPrec i 5 (concatD [prt 5 exp0 , doc (showString "=>") , prt 6 exp])
   PosEImplies span exp0 exp -> prPrec i 5 (concatD [prt 0 span , prt 5 exp0 , doc (showString "=>") , prt 6 exp])
   EOr exp0 exp -> prPrec i 6 (concatD [prt 6 exp0 , doc (showString "||") , prt 7 exp])
   PosEOr span exp0 exp -> prPrec i 6 (concatD [prt 0 span , prt 6 exp0 , doc (showString "||") , prt 7 exp])
   EXor exp0 exp -> prPrec i 7 (concatD [prt 7 exp0 , doc (showString "xor") , prt 8 exp])
   PosEXor span exp0 exp -> prPrec i 7 (concatD [prt 0 span , prt 7 exp0 , doc (showString "xor") , prt 8 exp])
   EAnd exp0 exp -> prPrec i 8 (concatD [prt 8 exp0 , doc (showString "&&") , prt 9 exp])
   PosEAnd span exp0 exp -> prPrec i 8 (concatD [prt 0 span , prt 8 exp0 , doc (showString "&&") , prt 9 exp])
   LtlRel exp0 exp -> prPrec i 9 (concatD [prt 9 exp0 , doc (showString "R") , prt 10 exp])
   PosLtlRel span exp0 exp -> prPrec i 9 (concatD [prt 0 span , prt 9 exp0 , doc (showString "R") , prt 10 exp])
   LtlUntil exp0 exp -> prPrec i 9 (concatD [prt 9 exp0 , doc (showString "U") , prt 10 exp])
   PosLtlUntil span exp0 exp -> prPrec i 9 (concatD [prt 0 span , prt 9 exp0 , doc (showString "U") , prt 10 exp])
   LtlWUntil exp0 exp -> prPrec i 9 (concatD [prt 9 exp0 , doc (showString "W") , prt 10 exp])
   PosLtlWUntil span exp0 exp -> prPrec i 9 (concatD [prt 0 span , prt 9 exp0 , doc (showString "W") , prt 10 exp])
   LtlF exp -> prPrec i 10 (concatD [doc (showString "F") , prt 11 exp])
   PosLtlF span exp -> prPrec i 10 (concatD [prt 0 span , doc (showString "F") , prt 11 exp])
   LtlG exp -> prPrec i 10 (concatD [doc (showString "G") , prt 11 exp])
   PosLtlG span exp -> prPrec i 10 (concatD [prt 0 span , doc (showString "G") , prt 11 exp])
   LtlX exp -> prPrec i 11 (concatD [doc (showString "X") , prt 12 exp])
   PosLtlX span exp -> prPrec i 11 (concatD [prt 0 span , doc (showString "X") , prt 12 exp])
   ENeg exp -> prPrec i 12 (concatD [doc (showString "!") , prt 13 exp])
   PosENeg span exp -> prPrec i 12 (concatD [prt 0 span , doc (showString "!") , prt 13 exp])
   ELt exp0 exp -> prPrec i 13 (concatD [prt 13 exp0 , doc (showString "<") , prt 14 exp])
   PosELt span exp0 exp -> prPrec i 13 (concatD [prt 0 span , prt 13 exp0 , doc (showString "<") , prt 14 exp])
   EGt exp0 exp -> prPrec i 13 (concatD [prt 13 exp0 , doc (showString ">") , prt 14 exp])
   PosEGt span exp0 exp -> prPrec i 13 (concatD [prt 0 span , prt 13 exp0 , doc (showString ">") , prt 14 exp])
   EEq exp0 exp -> prPrec i 13 (concatD [prt 13 exp0 , doc (showString "=") , prt 14 exp])
   PosEEq span exp0 exp -> prPrec i 13 (concatD [prt 0 span , prt 13 exp0 , doc (showString "=") , prt 14 exp])
   ELte exp0 exp -> prPrec i 13 (concatD [prt 13 exp0 , doc (showString "<=") , prt 14 exp])
   PosELte span exp0 exp -> prPrec i 13 (concatD [prt 0 span , prt 13 exp0 , doc (showString "<=") , prt 14 exp])
   EGte exp0 exp -> prPrec i 13 (concatD [prt 13 exp0 , doc (showString ">=") , prt 14 exp])
   PosEGte span exp0 exp -> prPrec i 13 (concatD [prt 0 span , prt 13 exp0 , doc (showString ">=") , prt 14 exp])
   ENeq exp0 exp -> prPrec i 13 (concatD [prt 13 exp0 , doc (showString "!=") , prt 14 exp])
   PosENeq span exp0 exp -> prPrec i 13 (concatD [prt 0 span , prt 13 exp0 , doc (showString "!=") , prt 14 exp])
   EIn exp0 exp -> prPrec i 13 (concatD [prt 13 exp0 , doc (showString "in") , prt 14 exp])
   PosEIn span exp0 exp -> prPrec i 13 (concatD [prt 0 span , prt 13 exp0 , doc (showString "in") , prt 14 exp])
   ENin exp0 exp -> prPrec i 13 (concatD [prt 13 exp0 , doc (showString "not") , doc (showString "in") , prt 14 exp])
   PosENin span exp0 exp -> prPrec i 13 (concatD [prt 0 span , prt 13 exp0 , doc (showString "not") , doc (showString "in") , prt 14 exp])
   QuantExp quant exp -> prPrec i 14 (concatD [prt 0 quant , prt 18 exp])
   PosQuantExp span quant exp -> prPrec i 14 (concatD [prt 0 span , prt 0 quant , prt 18 exp])
   EAdd exp0 exp -> prPrec i 15 (concatD [prt 15 exp0 , doc (showString "+") , prt 16 exp])
   PosEAdd span exp0 exp -> prPrec i 15 (concatD [prt 0 span , prt 15 exp0 , doc (showString "+") , prt 16 exp])
   ESub exp0 exp -> prPrec i 15 (concatD [prt 15 exp0 , doc (showString "-") , prt 16 exp])
   PosESub span exp0 exp -> prPrec i 15 (concatD [prt 0 span , prt 15 exp0 , doc (showString "-") , prt 16 exp])
   EMul exp0 exp -> prPrec i 16 (concatD [prt 16 exp0 , doc (showString "*") , prt 17 exp])
   PosEMul span exp0 exp -> prPrec i 16 (concatD [prt 0 span , prt 16 exp0 , doc (showString "*") , prt 17 exp])
   EDiv exp0 exp -> prPrec i 16 (concatD [prt 16 exp0 , doc (showString "/") , prt 17 exp])
   PosEDiv span exp0 exp -> prPrec i 16 (concatD [prt 0 span , prt 16 exp0 , doc (showString "/") , prt 17 exp])
   ESumSetExp exp -> prPrec i 17 (concatD [doc (showString "sum") , prt 18 exp])
   PosESumSetExp span exp -> prPrec i 17 (concatD [prt 0 span , doc (showString "sum") , prt 18 exp])
   ECSetExp exp -> prPrec i 17 (concatD [doc (showString "#") , prt 18 exp])
   PosECSetExp span exp -> prPrec i 17 (concatD [prt 0 span , doc (showString "#") , prt 18 exp])
   EMinExp exp -> prPrec i 17 (concatD [doc (showString "-") , prt 18 exp])
   PosEMinExp span exp -> prPrec i 17 (concatD [prt 0 span , doc (showString "-") , prt 18 exp])
   EImpliesElse exp0 exp1 exp -> prPrec i 18 (concatD [doc (showString "if") , prt 18 exp0 , doc (showString "then") , prt 18 exp1 , doc (showString "else") , prt 19 exp])
   PosEImpliesElse span exp0 exp1 exp -> prPrec i 18 (concatD [prt 0 span , doc (showString "if") , prt 18 exp0 , doc (showString "then") , prt 18 exp1 , doc (showString "else") , prt 19 exp])
   EInt posinteger -> prPrec i 19 (concatD [prt 0 posinteger])
   PosEInt span posinteger -> prPrec i 19 (concatD [prt 0 span , prt 0 posinteger])
   EDouble posdouble -> prPrec i 19 (concatD [prt 0 posdouble])
   PosEDouble span posdouble -> prPrec i 19 (concatD [prt 0 span , prt 0 posdouble])
   EStr posstring -> prPrec i 19 (concatD [prt 0 posstring])
   PosEStr span posstring -> prPrec i 19 (concatD [prt 0 span , prt 0 posstring])
   ESetExp setexp -> prPrec i 19 (concatD [prt 0 setexp])
   PosESetExp span setexp -> prPrec i 19 (concatD [prt 0 span , prt 0 setexp])
