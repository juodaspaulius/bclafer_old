...
newtype Immutable = Immutable ((Int,Int),String) deriving (Eq,Ord,Show)
...
data Constraint =
   Constraint [ConstrExp]
 | PosConstraint Span [ConstrExp]
  deriving (Eq,Ord,Show)
...
data TmpScope =
   TmpScopeGlobally
 | PosTmpScopeGlobally Span
 | TmpScopeBefore Exp
 | PosTmpScopeBefore Span Exp
 | TmpScopeAfter Exp
 | PosTmpScopeAfter Span Exp
 | TmpScopeBetweenAnd Exp Exp
 | PosTmpScopeBetweenAnd Span Exp Exp
 | TmpScopeAfterUntil Exp Exp
 | PosTmpScopeAfterUntil Span Exp Exp
  deriving (Eq,Ord,Show)

data ConstrExp =
   ImmutableConstr Immutable
 | PosImmutableConstr Span Immutable
 | ConstrExp Exp
 | PosConstrExp Span Exp
  deriving (Eq,Ord,Show)

data DeclLetBindingValue =
   DeclLetBindingValue PosIdent Exp
 | PosDeclLetBindingValue Span PosIdent Exp
  deriving (Eq,Ord,Show)

data DeclBindingSet =
   DeclBindingSet PosIdent SetExp
 | PosDeclBindingSet Span PosIdent SetExp
  deriving (Eq,Ord,Show)

data SetExp =
   DeclBindSet1 [DeclBindingSet] Exp
 | PosDeclBindSet1 Span [DeclBindingSet] Exp
 | DeclBindSet2 [Decl] Exp
 | PosDeclBindSet2 Span [Decl] Exp
 | Union SetExp SetExp
...
data Exp =
   DeclLetBindValue [DeclLetBindingValue] Exp
 | PosDeclLetBindValue Span [DeclLetBindingValue] Exp
 ...
 | TmpPrecedes Exp Exp TmpScope
 | PosTmpPrecedes Span Exp Exp TmpScope
 | TmpRespondsTo Exp Exp TmpScope
 ...
 | LtlRel Exp Exp
 | PosLtlRel Span Exp Exp
 | LtlUntil Exp Exp
 | PosLtlUntil Span Exp Exp
 | LtlWUntil Exp Exp
 | PosLtlWUntil Span Exp Exp
 | LtlF Exp
 | PosLtlF Span Exp
 | LtlG Exp
 | PosLtlG Span Exp
